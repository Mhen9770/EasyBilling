...
import com.easybilling.service.UserService;
...
public class UserController extends BaseController {
    ...
    public ApiResponse<UserProfileResponse> updateCurrentUserProfile(@Valid @RequestBody UpdateProfileRequest request) {
        String userId = getCurrentUserId();
